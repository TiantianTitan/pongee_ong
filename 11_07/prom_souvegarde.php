...
<body>
    ...
    <header class='full-width half-height is-not-signed-in p1'>
        <div class="top-bar">
            <a href='https://formationpangee.com/dashboard.php'>
                <img src="/assets/uploadImage/Icon_bouton/home.png" class="profile-img" alt="Home">
            </a>
            <div class="center-container">
                <img src="/images/LOGO-ONG.png" class="center-icon" alt="Logo">
            </div>
            <ul class="navbar-nav my-lg-0 ml-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="/assets/uploadImage/Profile/profil.png" class="profile-img">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right animated zoomIn"> 
                        <a class="dropdown-item" href="./constant/reset_password.php"><i class="fa fa-key"></i> Modifier mot de passe</a>
    ...
    <div class='container'>
        <div class='row'>
            <div class='col-md-6 course-description'>
                <h2>Programme de la formation <?php echo htmlspecialchars($categoryName, ENT_QUOTES, 'UTF-8'); ?></h2>
                <div><?php echo $categoryDescription; ?></div>
                <!-- 添加进入QCM的按钮 -->
                <a href="show_qcm.php?id=<?php echo $soto; ?>" class="btn btn-success">Faire un test</a>
                <!-- 添加查看结果的按钮 -->
                <a href="view_results.php?course_id=<?php echo $soto; ?>" class="btn btn-info">Afficher l'historique des tests</a>
            </div>
